...
// This cron job is commented out for free-tier deployments (e.g. Render) 
// because free servers sleep after 15m, which kills in-memory cron jobs.
// Use cron-job.org to ping the /api/cron/trigger endpoint instead!

// export const startCronJobs = () => {
//   console.log('⏳ Scraper Cron Jobs initialized...')
//   
//   cron.schedule('0 */6 * * *', async () => {
//     console.log('🔄 Running scheduled price checks via node-cron...')
//     await runPriceCheck()
//   })
// }
